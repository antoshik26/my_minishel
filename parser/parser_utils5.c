...
int parser_flags_utils2(t_command_and_flag *one_command, t_minishell *all_command)
{
...
int parser_flags_utils4(t_command_and_flag *one_command, t_minishell *all_command, int *i)
{
