...
int ft_clear_flags_from_kov_utils(t_minishell *all_command, t_command_and_flag *command, int i, int j)
{
	int l;
	int k;
	int len;
...
int ft_clear_flags_from_kov_utils2(t_minishell *all_command, t_command_and_flag *command, int i, int j)
{
	int l;
	int k;
	int len;
